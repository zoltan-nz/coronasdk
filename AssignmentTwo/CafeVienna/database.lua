...
M = {
	...
	products= {
		...
		{id=20, category_id= 3, name= 'Hamburger'       , image = 'product_images/20.jpg', price='€ 5.10', details='A hamburger is a sandwich consisting of one or more cooked patties of ground meat placed inside a sliced hamburger bun. Served with lettuce, bacon, tomato, onion, pickles, cheese and condiments such as mustard, mayonnaise, ketchup and relish.' },
		...
		{id=22, category_id= 3, name= 'Submarine Sandwich',image = 'product_images/22.jpg', price='€ 4.50', details='A submarine sandwich, also known as a sub, hoagie, hero, grinder, or one of many regional naming variations, is a sandwich that consists of a long roll of Italian or French bread. Filled with a variety of meats, cheeses, vegetables.' },
		{id=23, category_id= 4, name= 'Chef Salad'       ,image = 'product_images/23.jpg', price='€ 4.10', details='Chef salad is a salad consisting of hard-boiled eggs; one or more varieties of meat, such as ham, turkey, chicken, or roast beef; tomatoes; cucumbers; and cheese; all placed upon a bed of tossed lettuce or other leaf vegetables.' },
